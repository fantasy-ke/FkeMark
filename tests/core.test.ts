...
describe('AI assistant i18n', () => {
  it('contains the labels used by the editor and settings UI', () => {
    const keys = [
      ...
      'ai.settings.fullUrl',
      'ai.settings.baseUrl',
      'ai.settings.fullEndpoint',
      'ai.settings.test',
      'ai.settings.model',
      'ai.settings.models.fetch',
      'ai.settings.apiKey',
      'ai.settings.targetLanguage',
      'ai.settings.temperature',
      'ai.settings.privacyHint',
      'ai.settings.mcp.permission',
      'ai.settings.mcp.permission.hint',
      'ai.settings.mcp.permission.read-only',
      'ai.settings.mcp.permission.data-read-write',
      'ai.settings.mcp.permission.full-access',
      'ai.settings.mcp.recommended',
      'ai.settings.mcp.permission.summary',
      'ai.settings.mcp.matrixTitle',
      'ai.settings.mcp.capability',
      'ai.settings.mcp.capability.queryRead',
      'ai.settings.mcp.capability.scopedDataChange',
      'ai.settings.mcp.capability.destructiveDataChange',
      'ai.settings.mcp.capability.ddlAdmin',
      'ai.settings.mcp.capability.connectionManage',
      'ai.settings.mcp.allowed',
      'ai.settings.mcp.blocked',
      'ai.settings.mcp.permission.footnote',
      'ai.settings.mcp.examplesTitle',
      'ai.settings.mcp.example.scenario',
      'ai.settings.mcp.example.config',
      'ai.settings.mcp.example.guard',
      'ai.settings.mcp.example.read-only.scenario',
      'ai.settings.mcp.example.read-only.config',
      'ai.settings.mcp.example.read-only.guard',
      'ai.settings.mcp.example.data-read-write.scenario',
      'ai.settings.mcp.example.data-read-write.config',
      'ai.settings.mcp.example.data-read-write.guard',
      'ai.settings.mcp.example.full-access.scenario',
      'ai.settings.mcp.example.full-access.config',
      'ai.settings.mcp.example.full-access.guard',
      'palette.aiContinue',
      'palette.aiSummarize',
      'palette.aiPolish',
      'palette.aiTranslate',
