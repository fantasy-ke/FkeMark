...
这里是 FkeMark 的独立文档站源码，内容集中放在 <code>doc/</code> 文件夹内。站点使用 **VitePress + VitePress Theme Teek** 构建，并叠加 FkeMark 自己的“墨纸 Vellum”阅读视觉。
...
- **保留 FkeMark 风格**：自定义 CSS 统一首页、文档正文、侧边栏和顶部导航的纸感背景、墨色正文、墨绿/暖棕配色。
...
- <code>.vitepress/theme/custom.css</code> 叠加 FkeMark 的“墨纸 Vellum”视觉，并统一首页、正文区域、顶部导航和侧边栏背景。
- <code>public/theme/fkemark-vellum.css</code> 提供可在应用 Markdown 预览区复用的阅读主题 CSS。
