...
FkeMark is a desktop Markdown editor built around one goal: **keep files as normal <code>.md</code> documents while making editing feel closer to the final article**.
