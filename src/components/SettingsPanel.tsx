          ...
          {activeSection === 'behavior' && (
            <>
              ...
              <FlatGroup title={t('settings.versionSnapshotLimit')}>
                <div className="settings-row">
                  <div className="settings-label-group">
                    <div className="settings-label">{t('settings.versionSnapshotLimit')}</div>
                    <div className="settings-hint">{t('settings.versionSnapshotLimit.hint')}</div>
                  </div>
                  <div className="settings-radio-group">
                    {VERSION_SNAPSHOT_LIMIT_OPTIONS.map((limit) => (
                      <button
                        key={limit}
                        type="button"
                        className={`settings-radio-btn ${settings.versionSnapshotLimit === limit ? 'active' : ''}`}
                        onClick={() => update({ versionSnapshotLimit: limit })}
                      >
                        {t('settings.versionSnapshotLimit.option', { n: limit })}
                      </button>
                    ))}
                  </div>
                </div>
