...
export function ActivityRail({ active, onChange, onOpenGraph, onOpenRecycleBin, onOpenSettings, onOpenTerminal, labels }: ActivityRailProps) {
  const views: SidebarView[] = ['files', 'outline', 'backlinks', 'history']
  return (
