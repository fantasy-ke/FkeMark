...
const ALL_COMMANDS: SlashCommand[] = [
  ...
  { id: 'todo', label: '任务列表', desc: '- [ ] 待办', icon: '☐', keywords: 'todo task 任务 待办 checkbox' },
  { id: 'code', label: '行内代码', desc: '`代码`', icon: '</>', keywords: 'code 代码 inline' },
  { id: 'codeblock', label: '代码块', desc: '``` 代码块（带高亮）', icon: '{ }', keywords: 'codeblock 代码块 pre highlight' },
  { id: 'table', label: '表格', desc: '| 列 | 列 |', icon: '▦', keywords: 'table 表格 grid' },
