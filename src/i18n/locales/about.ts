...
export const aboutZhCN: Dict = {
  ...
  'about.credits.desc':
    '感谢 Tauri、React、ProseMirror、TipTap、Shiki 等开源项目，' +
...
export const aboutEnUS: Dict = {
  ...
  'about.credits.desc':
    'Thanks to open-source projects such as Tauri, React, ProseMirror, TipTap, and Shiki, ' +
