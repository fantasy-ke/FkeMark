...
export const sidebarLayoutZhCN: Dict = {
  ...
  'sidebar.console': '终端',
  'sidebar.console.failed': '打开终端失败：{detail}',
  'sidebar.console.desktopOnly': '系统终端只在桌面端可用',
  'sidebar.history.close': '关闭历史',
  'sidebar.tab.history': '历史',
  'sidebar.recentFiles': '最近文件',
  'sidebar.history.empty': '还没有最近打开的目录',
  'sidebar.history.filesEmpty': '还没有最近打开的文件',
}
...
export const sidebarLayoutEnUS: Dict = {
  ...
  'sidebar.console.failed': 'Failed to open terminal: {detail}',
  'sidebar.console.desktopOnly': 'The system terminal is only available in the desktop app',
  'sidebar.history.close': 'Close history',
  'sidebar.tab.history': 'History',
  'sidebar.recentFiles': 'Recent files',
  'sidebar.history.empty': 'No recently opened folders',
  'sidebar.history.filesEmpty': 'No recently opened files',
}
