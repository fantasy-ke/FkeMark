...
export const enUS: Dict = {
  ...
  'sidebar.context.newMarkdown': 'New Markdown file',
  'sidebar.context.newExcalidraw': 'New Excalidraw',
  'sidebar.context.newExcalidrawSuccess': 'Sketch file created',
  'sidebar.context.newExcalidrawFailed': 'Failed to create sketch file: {detail}',
  'sidebar.context.insertExcalidraw': 'Insert reference',
  'sidebar.search.placeholder': 'Search text content…',
  'sidebar.search.clear': 'Clear search',
  'sidebar.search.noFolder': 'Open a folder first',
  'sidebar.search.searching': 'Searching…',
  'sidebar.search.empty': 'No matches found',
  'sidebar.search.failed': 'Search failed, please retry',
  'sidebar.search.summary': '{matches} matches in {files} files',
  'sidebar.search.viewTree': 'Tree view',
  'sidebar.search.viewList': 'List view',
  'sidebar.search.collapse': 'Collapse',
  'sidebar.search.expand': 'Expand',
  'sidebar.search.collapseAll': 'Collapse all',
  'sidebar.search.expandAll': 'Expand all',
  'sidebar.context.newMarkdownSuccess': 'Markdown file created',
  'sidebar.context.newMarkdownFailed': 'Failed to create file: {detail}',
  'sidebar.context.newMarkdownExists': 'File already exists',
  'sidebar.context.newMarkdownInvalid': 'File name cannot contain a path',
  ...
  'slash.cmd.mermaid': 'Mermaid diagram',
  'slash.cmd.excalidraw': 'Excalidraw sketch',
  'slash.cmd.excalidrawFile': 'Reference sketch file',
  ...
  'slash.desc.mermaid': '```mermaid',
  'slash.desc.excalidraw': '```excalidraw',
  'slash.desc.excalidrawFile': './sketch.excalidraw',
  ...
  'editor.mermaid.edit': 'Edit source',
  'editor.mermaid.done': 'Done',
  'editor.mermaid.view': 'View diagram',
  'editor.mermaid.zoomIn': 'Zoom in',
  'editor.mermaid.zoomOut': 'Zoom out',
  'editor.mermaid.zoomReset': 'Reset',
  'editor.mermaid.close': 'Close',
  'editor.mermaid.empty': 'Enter Mermaid source',
  'editor.excalidraw.edit': 'Draw',
  'editor.excalidraw.cite': 'Reference file',
  'editor.excalidraw.missing': 'The referenced sketch file was not found',
  'editor.excalidraw.done': 'Done',
  'editor.excalidraw.open': 'Open',
  'editor.excalidraw.save': 'Save as',
  'editor.excalidraw.empty': 'Blank sketch',
  'editor.excalidraw.invalid': 'This sketch cannot be read',
  'editor.excalidraw.loadFailed': 'Failed to load the whiteboard',
  'editor.excalidraw.openFile': 'Open Excalidraw file',
  'editor.excalidraw.saveFile': 'Save Excalidraw file',
  'editor.excalidraw.openFailed': 'Open failed. Choose a valid .excalidraw file.',
  'editor.excalidraw.saved': 'Saved as an .excalidraw file',
  'editor.excalidraw.saveFailed': 'Save failed',
