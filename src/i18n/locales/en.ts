...
export const enUS: Dict = {
  ...
  'settings.toolbarCustomize.hint': 'Choose whether each syntax button is shown, hidden, or placed in a dropdown group, and add separators before buttons when needed.',
