...
export const enUS: Dict = {
  ...
  'settings.theme.absolutely': 'Neon Violet',
  'settings.theme.absolutely.desc': 'A saturated neon palette for stronger contrast in dark mode.',
  ...
  'settings.theme.gruvbox': 'Warm Ember',
  'settings.theme.gruvbox.desc': 'A copper-orange light palette with warmer surfaces for softer long-form reading.',
  ...
  'settings.toolbarHidden': 'Hidden',
  'settings.toolbarHidden.hint': 'Drag upward to show; Enter or Space also switches zones',
  'settings.toolbarDivider': 'Toolbar divider',
  'settings.toolbarDropEmpty': 'Drop icons here',
  'settings.toolbarButton.hint': 'Controls where this syntax button appears in the toolbar',
  'settings.toolbarPlacement.toolbar': 'Show on toolbar',
  'settings.toolbarPlacement.hidden': 'Hide',
  'settings.toolbarPlacement.group': 'Dropdown groups',
  'settings.toolbarGroup.format': 'Format group',
  'settings.toolbarGroup.block': 'Block group',
  'settings.toolbarGroup.insert': 'Insert group',
  'settings.toolbarGroup.utility': 'Utility group',
  'settings.toolbarSeparatorBefore': 'Add separator before',
  ...
  'sidebar.context.copyPath': 'Copy Path',
  'sidebar.context.openLocation': 'Show in File Manager',
  'sidebar.context.delete': 'Delete',
  'sidebar.context.renameTitle': 'Rename',
  'sidebar.context.renamePrompt': 'Enter a new name',
  'sidebar.context.renameSuccess': 'Renamed',
  'sidebar.context.renameFailed': 'Rename failed: {detail}',
  'sidebar.context.duplicateSuccess': 'Duplicated',
  'sidebar.context.duplicateFailed': 'Duplicate failed: {detail}',
  'sidebar.context.copyPathFailed': 'Failed to copy path: {detail}',
  ...
  'palette.aiContinue': 'AI: Continue',
  'palette.aiSummarize': 'AI: Summarize',
  'palette.aiPolish': 'AI: Polish',
  'palette.aiTranslate': 'AI: Translate',
  ...
  'trash.confirmPurge': 'Are you sure you want to permanently delete this item? This action cannot be undone.',
  'trash.confirmEmpty': 'Are you sure you want to empty the recycle bin? All items will be permanently deleted. This action cannot be undone.',
