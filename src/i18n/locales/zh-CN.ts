...
export const zhCN: Dict = {
  ...
  'settings.toolbarHidden': '已隐藏',
  'settings.toolbarHidden.hint': '拖到上方即可显示；Enter 或空格键也可切换',
  'settings.toolbarDivider': '工具栏分割线',
  'settings.toolbarDropEmpty': '拖拽图标到这里',
  'settings.toolbarButton.hint': '控制这个语法按钮在工具栏中的位置',
  'settings.toolbarPlacement.toolbar': '直接显示',
  'settings.toolbarPlacement.hidden': '隐藏',
  'settings.toolbarPlacement.group': '收进下拉分组',
  'settings.toolbarGroup.format': '格式分组',
  'settings.toolbarGroup.block': '块级分组',
  'settings.toolbarGroup.insert': '插入分组',
  'settings.toolbarGroup.utility': '工具分组',
  'settings.toolbarSeparatorBefore': '前面加分隔符',
  ...
  'sidebar.context.duplicate': '复制',
  'sidebar.context.copyPath': '复制路径',
  'sidebar.context.openLocation': '打开当前所在位置',
  'sidebar.context.delete': '删除',
  'sidebar.context.newMarkdown': '新建 Markdown 文件',
  'sidebar.context.newExcalidraw': '新建 Excalidraw',
  'sidebar.context.newExcalidrawSuccess': '已创建手绘文件',
  'sidebar.context.newExcalidrawFailed': '创建手绘文件失败：{detail}',
  'sidebar.context.insertExcalidraw': '引用到当前文档',
  'sidebar.search.placeholder': '搜索文本内容…',
  'sidebar.search.clear': '清除搜索',
  'sidebar.search.noFolder': '请先打开一个文件夹',
  'sidebar.search.searching': '搜索中…',
  'sidebar.search.empty': '未找到匹配内容',
  'sidebar.search.failed': '搜索失败，请重试',
  'sidebar.search.summary': '在 {files} 个文件中找到 {matches} 个匹配',
  'sidebar.search.viewTree': '树形结构',
  'sidebar.search.viewList': '列表结构',
  'sidebar.search.collapse': '折叠',
  'sidebar.search.expand': '展开',
  'sidebar.search.collapseAll': '全部折叠',
  'sidebar.search.expandAll': '全部展开',
  'sidebar.context.newMarkdownSuccess': '已创建 Markdown 文件',
  'sidebar.context.newMarkdownFailed': '创建失败：{detail}',
  'sidebar.context.newMarkdownExists': '文件已存在',
  'sidebar.context.newMarkdownInvalid': '文件名不能包含路径',
  'sidebar.context.renameTitle': '重命名',
  'sidebar.context.renamePrompt': '请输入新名称',
  'sidebar.context.renameSuccess': '已重命名',
  'sidebar.context.renameFailed': '重命名失败：{detail}',
  'sidebar.context.duplicateSuccess': '已复制',
  'sidebar.context.duplicateFailed': '复制失败：{detail}',
  'sidebar.context.copyPathFailed': '复制路径失败：{detail}',
  ...
  'slash.cmd.mermaid': 'Mermaid 图表',
  'slash.cmd.excalidraw': 'Excalidraw 手绘白板',
  'slash.cmd.excalidrawFile': '引用手绘文件',
  'slash.desc.h1': '# 标题',
  'slash.desc.h2': '## 标题',
  'slash.desc.h3': '### 标题',
  'slash.desc.h4': '#### 标题',
  ...
  'palette.aiContinue': 'AI：续写',
  'palette.aiSummarize': 'AI：摘要',
  'palette.aiPolish': 'AI：润色',
  'palette.aiTranslate': 'AI：翻译',
  ...
  'trash.restore': '还原',
  'trash.purge': '永久删除',
  'trash.confirmPurge': '确定要永久删除此项目吗？此操作不可撤销。',
  'trash.confirmEmpty': '确定要清空回收站吗？所有项目将被永久删除，此操作不可撤销。',
  ...
  'editor.mermaid.edit': '编辑源码',
  'editor.mermaid.done': '完成',
  'editor.mermaid.view': '放大查看',
  'editor.mermaid.zoomIn': '放大',
  'editor.mermaid.zoomOut': '缩小',
  'editor.mermaid.zoomReset': '重置',
  'editor.mermaid.close': '关闭',
  'editor.mermaid.empty': '输入 Mermaid 源码',
  'editor.excalidraw.edit': '绘制',
  'editor.excalidraw.cite': '引用文件',
  'editor.excalidraw.missing': '找不到引用的手绘文件',
  'editor.excalidraw.done': '完成',
  'editor.excalidraw.open': '打开图',
  'editor.excalidraw.save': '另存为',
  'editor.excalidraw.empty': '空白手绘白板',
  'editor.excalidraw.invalid': '无法读取这张手绘图',
  'editor.excalidraw.loadFailed': '白板加载失败',
  'editor.excalidraw.openFile': '打开 Excalidraw 文件',
  'editor.excalidraw.saveFile': '保存 Excalidraw 文件',
  'editor.excalidraw.openFailed': '打开失败，请选择有效的 .excalidraw 文件',
  'editor.excalidraw.saved': '已另存为 .excalidraw 文件',
  'editor.excalidraw.saveFailed': '另存失败',
  ...
  // 图片管理面板
  'imageManager.open': '图片管理',
  'imageManager.title': '图片管理',
  'imageManager.summary': '当前文档共 {count} 张图片',
  'imageManager.close': '关闭图片管理',
  'imageManager.emptyTitle': '本文还没有图片',
  'imageManager.emptyHint': '插入 Markdown 图片或 HTML img 标签后，将在这里统一管理。',
  'imageManager.occurrences': '引用 {count} 次',
  'imageManager.kind.local': '本地',
  'imageManager.kind.remote': '网络',
  'imageManager.kind.data': '内嵌',
  'imageManager.kind.blob': '临时',
  'imageManager.rename': '重命名',
  'imageManager.replace': '替换',
  'imageManager.exportAll': '批量导出',
  'imageManager.exporting': '正在导出…',
  'imageManager.saveFirst': '请先保存当前文档，以确定图片资源目录。',
  'imageManager.desktopOnly': '图片文件操作仅在桌面应用中可用。',
  'imageManager.renameLocalOnly': '仅本地图片支持重命名',
  'imageManager.renameTitle': '重命名图片',
  'imageManager.renameLabel': '新文件名',
  'imageManager.renameHint': '可省略扩展名；为避免图片格式与内容不一致，扩展名保持不变。',
  'imageManager.renameConfirm': '确认重命名',
  'imageManager.renameEmptyError': '请输入文件名。',
  'imageManager.renameInvalidError': '文件名不能包含路径或系统保留字符。',
  'imageManager.renameExtensionError': '重命名时不能修改图片扩展名。',
  'imageManager.localPathError': '无法根据当前文档解析图片文件路径。',
  'imageManager.renameSuccess': '图片已重命名为 {name}',
  'imageManager.renameFailed': '图片重命名失败：{detail}',
  'imageManager.selectReplacement': '选择替换图片',
  'imageManager.replaceSuccess': '图片已替换为 {name}',
  'imageManager.replaceFailed': '图片替换失败：{detail}',
  'imageManager.selectExportFolder': '选择图片导出目录',
  'imageManager.noImages': '当前文档没有可导出的图片。',
