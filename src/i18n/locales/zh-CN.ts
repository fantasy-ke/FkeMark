...
export const zhCN: Dict = {
  ...
  'settings.theme.absolutely': '霓虹紫',
  'settings.theme.absolutely.desc': '高饱和霓虹配色，适合强调感更强的暗色界面。',
  ...
  'settings.theme.gruvbox': '暖曦橙',
  'settings.theme.gruvbox.desc': '暖铜橙浅色配色，让编辑区更有温度，长文档阅读更柔和。',
